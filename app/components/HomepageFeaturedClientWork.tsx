...
import type { FeaturedClientWorkQueryResult } from '@/sanity/lib/types'

export default function HomepageFeaturedClientWork({ data }: { data: FeaturedClientWorkQueryResult }) {
  ...
  return (
    <section className="py-20 border-t border-gray-100 dark:border-white/[0.05]">
      ...
      >
        <div>
          <h2 className="text-4xl md:text-5xl font-bold text-black dark:text-white">Freelance Work</h2>
          <p className="text-gray-500 dark:text-gray-400 mt-2">Client projects I&apos;ve built</p>
        </div>
        <Link
          href="/work"
      ...
      <div className="mt-8 sm:hidden">
        ...
        >
          View all freelance work <FaArrowRight className="h-3.5 w-3.5" />
        </Link>
      </div>
    </section>
  )
